...
public class MensagemBean {
	...
	public void enviarMensagem(ActionEvent event) throws Exception{
		...
		if(mensTexto == "")
		{
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "ERRO!!!","N�o � possivel enviar mensagem em branco!"));
		}
		else{
	...
	public void EnviarSelecionados(String mensTexto) throws Exception{
		...
		{
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "ERRO!!!","Mensagem n�o enviada selecione algum discipulo!"));
		}
		else
		{
